...
define view entity ZATS_ZH_BOOKSUPPL
  ...
  association        to parent ZATS_ZH_BOOKING     as _BOOKING        on  $projection.BookingId = _BOOKING.BookingId
                                                                      and $projection.TravelId  = _BOOKING.TravelId
  association of one to one ZATS_ZH_TRAVEL         as _Travel         on  $projection.TravelId = _Travel.TravelId
